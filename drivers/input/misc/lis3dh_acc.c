...
static int calculate_gsensor_cali_data(struct i2c_client *client, int data[LIS3DH_AXES_NUM+1])
{
	...
	data[LIS3DH_AXIS_X] = calibration_buf[LIS3DH_AXIS_X] / 16;
	data[LIS3DH_AXIS_Y] = calibration_buf[LIS3DH_AXIS_Y] / 16;
	data[LIS3DH_AXIS_Z] = calibration_buf[LIS3DH_AXIS_Z] / 16;
