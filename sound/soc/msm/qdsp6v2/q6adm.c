...
#ifdef VENDOR_EDIT //Jianfeng.Qiu@PhoneSw.AudioDriver, 2015/04/22, Add for LVVE
...
#ifdef VENDOR_EDIT //Jianfeng.Qiu@PhoneSw.AudioDriver, 2015/04/22, Modify for LVVE
